...
const addOne = (arr) => {
  const stuff = [];
  arr.forEach((value) => stuff.push(value + 1));
  return stuff;
};
...
//   let stuff = [];
//   arr.forEach((value) => {
//     stuff.push(value.toUpperCase());
//   });
//   return stuff;
// };
const allUpperCase = (arr) => {
  let stuff = [];
  arr.forEach((value) => stuff.push(value.toUpperCase()));
  return stuff;
};
...
const fizzbuzz = (arr) => {
  const stuff = [];
  arr.forEach((num) => {
    if (num % 3 === 0 && num % 5 === 0) stuff.push("Fizz Buzz");
    else if (num % 3 === 0) stuff.push("Fizz");
    else if (num % 5 === 0) stuff.push("Buzz");
    else stuff.push(num);
  });
  return stuff;
};
